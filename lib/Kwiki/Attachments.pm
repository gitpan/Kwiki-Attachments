...
Install Kwiki::Attachments, then uncomment (or add) 
the name of this module in your Kwiki's plugins file.

=head1 DESCRIPTION

This module gives a Kwiki wiki the ability to store and manage file 
